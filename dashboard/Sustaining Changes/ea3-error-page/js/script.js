document.addEventListener("DOMContentLoaded", function () {
  ...
  function setContentHeight() {
          var canvasFooterHeight = document.getElementById('off-canvas-footer').offsetHeight;
          ...
          contentDiv.style.height = (window.innerHeight - canvasFooterHeight - canvasHeaderHeight - 80) + 'px';
      }
